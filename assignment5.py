...
if length==breadth:
    print("dimension are square: ",length,breadth)
else:
    print("dimension are rectangle: ",length,breadth)

#Q.3- Take the input age of 3 people and determine oldest and youngest among them.
a1=int(input("input age of first people: "))
a2=int(input("enter age of second people: "))
a3=int(input("enter age of third people: "))
if a1>a2:
   max=a1
   min=a2
else:
